<table>
  <tr>
    <td valign="top">
      <h1>Saber Motamedi</h1>
      <p>Senior Full-Stack Engineer building scalable .NET systems, APIs, and modern web platforms.</p>
      <p>I work mainly across C#, ASP.NET Core, distributed systems, SQL, messaging, and frontend delivery with Angular or React. Interested in clean architecture, product engineering, and pragmatic system design.</p>
    </td>
    <td valign="top" align="right">
      <img src="./Saber.png" alt="Saber logo" width="140" />
    </td>
  </tr>
</table>
